...
const CursorGrid: React.FC<CursorGridProps> = ({
  ...
  useEffect(() => {
    ...
    const toLocal = (e: MouseEvent | TouchEvent): [number, number] => {
    ...
    container.addEventListener('touchmove', onPointerMove as any)
    container.addEventListener('touchstart', onPointerDown as any)
    ...
    return () => {
      ...
      container.removeEventListener('touchmove', onPointerMove as any)
      container.removeEventListener('touchstart', onPointerDown as any)
    }
  }, [cellSize])
